...
class Meditation3Page extends StatefulWidget {
  const Meditation3Page({super.key});

  @override
  _Meditation3PageState createState() => _Meditation3PageState();
}

class _Meditation3PageState extends State<Meditation3Page> {
  ...
  Future<void> _setupAudioPlayer() async {
    ...
    await _audioPlayer.setAudioSource(
      AudioSource.asset(
        "assets/audio/StressMeditation.mp3",
      ),
    );
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            Center(
              child: Image.asset('assets/images/meditation3.png', width: 250),
            ),
                      ...
                      builder: (context, snapshot) {
                        return ProgressBar(
                          ...
                          total: const Duration(
                              minutes: 12,
                              seconds: 15), // Update total duration
                          onSeek: (duration) {
            ...
            ...List.generate(2, (index) {
              String label =
                  index == 0 ? "Healing Meditation" : "Daily Meditation";
              String duration = index == 0 ? "17:16" : "12:58";
