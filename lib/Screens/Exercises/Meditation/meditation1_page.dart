...
class _Meditation1PageState extends State<Meditation1Page> {
  ...
  Future<void> _setupAudioPlayer() async {
    ...
    await _audioPlayer.setAudioSource(
      AudioSource.asset(
        "assets/audio/DailyMeditation.mp3",
      ),
    );
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            Center(
              child: Image.asset('assets/images/meditation1.png', width: 250),
            ),
                      ...
                      builder: (context, snapshot) {
                        return ProgressBar(
                          ...
                          total: const Duration(
                              minutes: 12,
                              seconds: 58), // Update total duration
                          onSeek: (duration) {
            ...
            ...List.generate(2, (index) {
              String label =
                  index == 0 ? "Healing Meditation" : "Stress Meditation";
              String duration = index == 0 ? "17:16" : "12:15";
