...
class DeterminatePageGAD extends StatefulWidget {
  const DeterminatePageGAD({super.key});

  @override
  _DeterminatePageGADState createState() => _DeterminatePageGADState();
}

class _DeterminatePageGADState extends State<DeterminatePageGAD> {
  late Timer _timer;
