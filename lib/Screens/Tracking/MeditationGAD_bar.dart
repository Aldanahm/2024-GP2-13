...
class DeterminatePageMedGAD extends StatefulWidget {
  const DeterminatePageMedGAD({super.key});

  @override
  _DeterminatePageState createState() => _DeterminatePageState();
}

class _DeterminatePageState extends State<DeterminatePageMedGAD> {
  late Timer _timer;
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10),
                  Image.asset(
                    'assets/images/NextStep.png', // Ensure this path is correct and the image is added to your assets
                    height: 30,
                    width: 30,
                  ),
                ],
