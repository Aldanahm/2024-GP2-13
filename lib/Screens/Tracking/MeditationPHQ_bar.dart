...
class DeterminatePageMedPHQ extends StatefulWidget {
  const DeterminatePageMedPHQ({super.key});

  @override
  _DeterminatePageState createState() => _DeterminatePageState();
}

class _DeterminatePageState extends State<DeterminatePageMedPHQ> {
  late Timer _timer;
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10),
                  Image.asset(
                    'assets/images/NextStep.png', // Make sure to provide the correct path to your image
                    height: 40,
                  ),
                ],
              ),
